...
#ifndef CONFIG_SCENE_DEFAULT_WAIT_MS
#define CONFIG_SCENE_DEFAULT_WAIT_MS 200
#endif

#if CONFIG_SCENE_DEFAULT_WAIT_MS < CONFIG_SCENE_MIN_WAIT_MS || \
    CONFIG_SCENE_DEFAULT_WAIT_MS > CONFIG_SCENE_MAX_WAIT_MS
#error "CONFIG_SCENE_DEFAULT_WAIT_MS must be within the scene wait range"
#endif
